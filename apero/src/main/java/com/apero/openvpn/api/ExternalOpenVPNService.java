...
import com.apero.openvpn.core.ConfigParser.ConfigParseError;
    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        private void startProfile(VpnProfile vp)
        {
            ...
            if(vpnPermissionIntent != null || neddPassword != 0){
                ...
                shortVPNIntent.setClass(getBaseContext(), com.apero.openvpn.LaunchVPN.class);
                shortVPNIntent.putExtra(com.apero.openvpn.LaunchVPN.EXTRA_KEY, vp.getUUIDString());
                shortVPNIntent.putExtra(com.apero.openvpn.LaunchVPN.EXTRA_HIDELOG, true);
