...
import com.apero.openvpn.api.ExternalCertificateProvider;
...
public class ExtAuthHelper {
    ...
    public static final String ACTION_CERT_CONFIGURATION = "com.apero.openvpn.api.ExternalCertificateConfiguration";
    public static final String ACTION_CERT_PROVIDER = "com.apero.openvpn.api.ExternalCertificateProvider";

    public static final String EXTRA_ALIAS = "com.apero.openvpn.api.KEY_ALIAS";
    public static final String EXTRA_DESCRIPTION = "com.apero.openvpn.api.KEY_DESCRIPTION";
