...
package com.apero.openvpn.core;
...
import com.apero.openvpn.R;
import com.apero.openvpn.VpnProfile;
import com.apero.openvpn.activities.DisconnectVPN;
import com.apero.openvpn.activities.VariantConfig;
import com.apero.openvpn.api.ExternalAppDatabase;
import com.apero.openvpn.core.VpnStatus.ByteCountListener;
import com.apero.openvpn.core.VpnStatus.StateListener;

import static com.apero.openvpn.core.ConnectionStatus.LEVEL_CONNECTED;
import static com.apero.openvpn.core.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;
import static com.apero.openvpn.core.NetworkSpace.IpAddress;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    public static final String START_SERVICE = "com.apero.openvpn.START_SERVICE";
    public static final String START_SERVICE_STICKY = "com.apero.openvpn.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "com.apero.openvpn.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "com.apero.openvpn.DISCONNECT_VPN";
    ...
    private static final String PAUSE_VPN = "com.apero.openvpn.PAUSE_VPN";
    private static final String RESUME_VPN = "com.apero.openvpn.RESUME_VPN";

    public static final String EXTRA_CHALLENGE_TXT = "com.apero.openvpn.core.CR_TEXT_CHALLENGE";
    public static final String EXTRA_CHALLENGE_OPENURL = "com.apero.openvpn.core.OPENURL_CHALLENGE";
    ...
    synchronized void unregisterDeviceStateReceiver() {
        if (mDeviceStateReceiver != null)
            try {
                ...
                // java.lang.IllegalArgumentException: Receiver not registered: com.apero.openvpn.NetworkSateReceiver@41a61a10
                // Ignore for now ...
                iae.printStackTrace();
            }
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class cl = Class.forName("com.apero.openvpn.core.OpenVPNThreadv3");
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("com.apero.openvpn.VPN_STATUS");
