...
import com.apero.openvpn.BuildConfig;
import com.apero.openvpn.core.VpnStatus.LogLevel;
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className,
            ...
            try {
                ...
                if (service.queryLocalInterface("com.apero.openvpn.core.IServiceStatus") == null) {
                    // Not a local service
